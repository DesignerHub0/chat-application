...
const ChatFeed = (props) => {
    ...
    const rendrReadReceipt = (message, isMyMessage) => {
        ...
        return keys.map((key,index) => {
            ...
            return (
                <div key={`msg_${index}`} style={{width : "100%"}}>
                    ...
                    <div className="read-receipts" style={{marginRight : isMyMessage ? '18px' : '0', marginLeft: isMyMessage ? '0' : '68px'}}>{rendrReadReceipt(message, isMyMessage)}</div>
                </div>
